...
def main():
    ...
    # Field options
    ap.add_argument('--field_grid', type=int, default=121, help='odd number, grid per axis')
    ...
    ap.add_argument('--eval_seq_len', type=int, default=256, help='shorter seq len to speed up field eval')
    ...
    ap.add_argument('--zo_dirs', type=int, default=16, help='# directions for two-point ZO')
    ...
    ax.set_title(f'Gradient Magnitude + Trajectories  (plane: {args.plane}, center: {args.center_mode})')
