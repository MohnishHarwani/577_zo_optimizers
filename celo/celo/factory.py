...
from celo.optimizers import mnemo_celo as mnemo_celo_lopt
...
def get_optimizer(name):
    ...
    elif name == "mnemo_celo_phase1":
        # Mnemo-CeLo phase 1 (if you want to do a two-stage training like CeLo)
        return mnemo_celo_lopt.MnemoCelo(
            hidden_dim=64,
            num_heads=4,
            num_loss_scales=8,
            base_lr=1e-3,
    ...
    elif name == "mnemo_celo":
        # Mnemo-CeLo full optimizer (phase 2 / meta-testing)
        return mnemo_celo_lopt.MnemoCelo(
            hidden_dim=32,
            num_heads=2,
            num_loss_scales=4,
